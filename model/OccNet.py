...
class Image2DEncoder(nn.Module):
    ...
    def __init__(self, c_dim=128, normalize=True, use_linear=True):
        ...
        self.features = models.resnet18(pretrained=True) # can use Mobilenetv3 if want to : self.features= models.mobilenet_v3_large(pretrained=True)
...
class LatentEncoder(nn.Module):
    ...
    def forward(self, p, x, c):
        ...
        return mean, logstd # mean size 128, logstd size =128
...
class OccupancyNetwork(nn.Module):
    ...
    def __init__(self):
        ...
        self.image2D_encoder = Image2DEncoder()
        self.latent_encoder=LatentEncoder()
        self.decoder= DecoderBatchNorm()


    def forward(self, image2D, pointcloud):
        c=self.image2D_encoder()
        #z=LatentEncoder(c) # what is z in tmean and std? 
        p=pointcloud
        out=DecoderBatchNorm(p,c,z=None)
        return out
